...
<head>
    ...
    <link rel="icon" type="image/jpg" href="C:\Users\steveen.dominguez\Desktop\download.jpg">
    <title>Login</title>
    <style>
        .father{
...
<body>
    <div class="father min-vh-100">
        <form class="child bg-success bg-gradient" method="POST" action="">
            @csrf
        <div class="mb-3">
